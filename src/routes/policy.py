...
@policy_bp.route('/policies/<policy_id>', methods=['GET'])
...
@policy_bp.route('/policies/<policy_id>/rules', methods=['POST'])
...
@policy_bp.route('/policies/<policy_id>/rules', methods=['GET'])
...
@policy_bp.route('/policies/<policy_id>/rules/<rule_id>', methods=['GET'])
...
@policy_bp.route('/policies/<policy_id>/rules/<rule_id>', methods=['PUT'])
...
@policy_bp.route('/policies/<policy_id>/rules/<rule_id>', methods=['DELETE'])
